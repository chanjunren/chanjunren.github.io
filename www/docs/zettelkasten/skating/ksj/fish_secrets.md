...
Forward movement in slalom depends on the angle between your two skate frames:

| Position | Foot shape | Going forward | Going backward |
|----------|-----------|---------------|----------------|
| **V** | Toes out | Accelerates | Decelerates |
| **A** | Toes in | Decelerates / brakes | Accelerates |
...
Basic skating cycle: push → recovery (lift foot) → glide → set down

In slalom (Fish especially): the **recovery phase is minimised** — the foot stays close to the ground to maintain control rather than maximise speed. This is what makes slalom feel different from regular skating.
