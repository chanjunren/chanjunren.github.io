...
function PopoverContent({ className, align = "center", sideOffset = 4, ...props }: React.ComponentProps<typeof PopoverPrimitive.Content>) {
  return <PopoverPrimitive.Portal><PopoverPrimitive.Content data-slot="popover-content" align={align} sideOffset={sideOffset} className={cn("z-50 w-auto rounded-md border bg-(--menu-background) text-(--menu-foreground) p-4 shadow-md outline-hidden", className)} {...props} /></PopoverPrimitive.Portal>;
}
